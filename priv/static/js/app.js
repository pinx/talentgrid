...
Elm.TalentGrid.Update.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "FacebookAuth") {
            ...
            var user = A2($Result.withDefault,$TalentGrid$Auth$Model.initialUser,_p0._0);
            return {ctor: "_Tuple2",_0: _U.update(model,{user: user}),_1: initialLoadEffects(user)};
         }
   });
...
Elm.TalentGrid.make = function (_elm) {
   ...
   var app = $StartApp.start({init: $TalentGrid$Update.init,update: $TalentGrid$Update.update,view: $TalentGrid$View.view,inputs: _U.list([loginAction])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.TalentGrid.values = {_op: _op,app: app,main: main,loginAction: loginAction};
};
