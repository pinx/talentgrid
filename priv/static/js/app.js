...
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.Auth = Elm.TalentGrid.Auth || {};
Elm.TalentGrid.Auth.Model = Elm.TalentGrid.Auth.Model || {};
Elm.TalentGrid.Auth.Model.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   _elm.TalentGrid.Auth = _elm.TalentGrid.Auth || {};
   _elm.TalentGrid.Auth.Model = _elm.TalentGrid.Auth.Model || {};
   if (_elm.TalentGrid.Auth.Model.values) return _elm.TalentGrid.Auth.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   A2($Json$Decode._op[":="],"authenticated",$Json$Decode.bool)));
   return _elm.TalentGrid.Auth.Model.values = {_op: _op
                                              ,User: User
                                              ,FacebookAuth: FacebookAuth
                                              ,initialUser: initialUser
                                              ,initialFacebookAuth: initialFacebookAuth
                                              ,loginWithFacebookUrl: loginWithFacebookUrl
                                              ,authParams: authParams
                                              ,userDecoder: userDecoder};
};
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.Action = Elm.TalentGrid.Action || {};
Elm.TalentGrid.Action.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   _elm.TalentGrid.Action = _elm.TalentGrid.Action || {};
   if (_elm.TalentGrid.Action.values) return _elm.TalentGrid.Action.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $TalentGrid$Auth$Model = Elm.TalentGrid.Auth.Model.make(_elm);
   var _op = {};
   var Login = function (a) {    return {ctor: "Login",_0: a};};
   var FacebookAuth = function (a) {    return {ctor: "FacebookAuth",_0: a};};
   return _elm.TalentGrid.Action.values = {_op: _op,FacebookAuth: FacebookAuth,Login: Login};
};
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.Model = Elm.TalentGrid.Model || {};
Elm.TalentGrid.Model.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   _elm.TalentGrid.Model = _elm.TalentGrid.Model || {};
   if (_elm.TalentGrid.Model.values) return _elm.TalentGrid.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $TalentGrid$Auth$Model = Elm.TalentGrid.Auth.Model.make(_elm);
   var _op = {};
   var initialModel = {user: $TalentGrid$Auth$Model.initialUser,facebookAuth: $TalentGrid$Auth$Model.initialFacebookAuth};
   var Model = F2(function (a,b) {    return {user: a,facebookAuth: b};});
   return _elm.TalentGrid.Model.values = {_op: _op,Model: Model,initialModel: initialModel};
};
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.Update = Elm.TalentGrid.Update || {};
Elm.TalentGrid.Update.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   _elm.TalentGrid.Update = _elm.TalentGrid.Update || {};
   if (_elm.TalentGrid.Update.values) return _elm.TalentGrid.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $TalentGrid$Action = Elm.TalentGrid.Action.make(_elm),
   $TalentGrid$Auth$Model = Elm.TalentGrid.Auth.Model.make(_elm),
   $TalentGrid$Model = Elm.TalentGrid.Model.make(_elm);
   var _op = {};
   var loginWithFacebook = function (fbAuth) {    var a = A2($Debug.log,"loginWithFacebook",fbAuth);return $Effects.none;};
   ...
   var update = F2(function (action,model) {
      var a = A2($Debug.log,"update",action);
      var _p0 = action;
      if (_p0.ctor === "FacebookAuth") {
            var _p1 = _p0._0;
            return {ctor: "_Tuple2",_0: _U.update(model,{facebookAuth: _p1}),_1: loginWithFacebook(_p1)};
         } else {
            var _p2 = _p0._0;
            return {ctor: "_Tuple2",_0: _U.update(model,{user: _p2}),_1: initialLoadEffects(_p2)};
         }
   });
   return _elm.TalentGrid.Update.values = {_op: _op,initialLoadEffects: initialLoadEffects,init: init,update: update,loginWithFacebook: loginWithFacebook};
};
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.View = Elm.TalentGrid.View || {};
Elm.TalentGrid.View.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   _elm.TalentGrid.View = _elm.TalentGrid.View || {};
   if (_elm.TalentGrid.View.values) return _elm.TalentGrid.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],"Welcome ",$Basics.toString(model)))]));
   });
   return _elm.TalentGrid.View.values = {_op: _op,view: view};
};
Elm.TalentGrid = Elm.TalentGrid || {};
Elm.TalentGrid.make = function (_elm) {
   "use strict";
   _elm.TalentGrid = _elm.TalentGrid || {};
   if (_elm.TalentGrid.values) return _elm.TalentGrid.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $TalentGrid$Auth$Model = Elm.TalentGrid.Auth.Model.make(_elm),
   $TalentGrid$Model = Elm.TalentGrid.Model.make(_elm),
   $TalentGrid$Update = Elm.TalentGrid.Update.make(_elm),
   $TalentGrid$View = Elm.TalentGrid.View.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   ...
   var loginActions = A2($Signal.map,$TalentGrid$Action.FacebookAuth,A2($Debug.log,"login",facebookLogin));
   var app = $StartApp.start({init: $TalentGrid$Update.init,update: $TalentGrid$Update.update,view: $TalentGrid$View.view,inputs: _U.list([loginActions])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.TalentGrid.values = {_op: _op,app: app,main: main,loginActions: loginActions};
};

require.register("web/elm/TalentGrid", function(exports, require, module) {
...
var Auth = exports.Auth = {
  ...
  hideFacebookLogin: function hideFacebookLogin() {
    document.getElementById('elm-main').style.display = 'block';
    document.getElementById('fblogin').style.display = 'none';
  },
  handleFacebookResponse: function handleFacebookResponse(fbResponse) {
